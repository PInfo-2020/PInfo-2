...
export class CreaterecipeComponent implements OnInit {
  ...
  ngOnInit(): void {
    (async () => {
      this.httprest.httpresponse=[];
      this.httprest.recvaddr="https://lookandcookproject.firebaseio.com/users/defaultuser/myrecipe.json?orderBy=\"name\"&equalTo=\"recettenouvelle\"";
      /*this.httprest.recvaddr="https://lookandcookproject.firebaseio.com/users/defaultuser/myrecipe/-M7gZ8fsttv95Oah4b2W.json";*/
      this.httprest.dataReceiveWithGet();
      ...
      console.log(this.httprest.toList(this.httprest.httpresponse));
    })();
  }
