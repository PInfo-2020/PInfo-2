...
export class ListrecipeComponent implements OnInit {
  ...
  deleteRecipe(indexOfelement,item){
    this.httprest.httpresponse=[];
    this.httprest.sendaddr="http://localhost:8080/JerseyDemo/myfridge/myrecipe/delete";
    this.httprest.sendjson=JSON.stringify(item);
    this.httprest.restSend();
  ...
  deleteFavourite(indexOfelement,item){
    this.httprest.httpresponse=[];
    this.httprest.sendaddr="http://localhost:8080/JerseyDemo/myfridge/myfavourite/delete";
    this.httprest.sendjson=JSON.stringify(item);
    this.httprest.restSend();
